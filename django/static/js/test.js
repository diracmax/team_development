...
var twitLike2 = document.getElementById("twitter-like2");

twitLike2.addEventListener("click", function(e) {
  e.preventDefault;
  if (twitLike2.classList.contains("a_liked")) {
    twitLike2.classList.remove("a_liked");
  } else {
    twitLike2.classList.toggle("twit-animated");
    twitLike2.classList.toggle("liked");
  }
}, false);
...
var twitLike = document.getElementsByClassName("twitter-like");
...
var twitLike2 = document.getElementsByClassName("twitter-like2");
